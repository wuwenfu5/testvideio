...
mnist = input_data.read_data_sets(r"/home/wuwenfu5/00UseDir/MNIST/train-images-idx3-ubyte/data", one_hot=True)
...
def conv2d(x, W):
    return tf.nb.conv2d(x, W, strides=[1, 1, 1, 1], padding='SAME')
